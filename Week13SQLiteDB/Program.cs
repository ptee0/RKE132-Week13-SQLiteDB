...
static void InsertCustomer(SQLiteConnection myConnection)
{
    ...
    int rowInserted = command.ExecuteNonQuery();//siin error, kui konsoolis DoB sisestada. System.Data.SQLite.SQLiteException: 'SQL logic error near "07": syntax error'
